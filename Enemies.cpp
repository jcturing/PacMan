...
void Enemy::SetCounter(int i) {
	counter = i;
}

void Enemy::SetStateCounter(int i) {
	state_counter = i;
}

void Enemy::SetMaxCounter(int i) {
	max_counter = i;
}
...
tDirection Enemy::GetDirection() const {
	return direction;
}
...
int Enemy::GetNextPositionX() const {
	return next_position.x;
}

int Enemy::GetNextPositionY() const {
	return next_position.y;
}

int Enemy::GetInitialPositionX() const {
	return initial_position.x;
}

int Enemy::GetInitialPositionY() const {
	return initial_position.y;
}

int Enemy::GetHousePositionX() const {
	return initial_house.x;
}

int Enemy::GetHousePositionY() const {
	return initial_house.y;
}

float Enemy::GetPixelPositionX() const {
	return position.pixel_x;
}

float Enemy::GetPixelPositionY() const {
...
int Enemy::GetStateCounter() const {
	return state_counter;
}

float Enemy::GetMaxCounter() const {
	return max_counter;
}

tGhost Enemy::GetType() const {
	return type;
}

int Enemy::GetIdleTime() const {
	return idle_time;
}
...
float distance(int posX, int posY, int targetX, int targetY) {
	float distance;
	float vertical = abs(posY - targetY);
	float horizontal = abs(posX - targetX);
	
	distance = sqrt(pow(vertical, 2) + pow(horizontal, 2));
